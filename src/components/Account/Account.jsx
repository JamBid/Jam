                ...
                {/*<!-- Account -->*/}
                    ...
                    <div className="col-7">
                        ...
                        <div className="input-group mb-3 info">
                            ...
                            <textarea id="email" className="update-task form-control update">email@gmail.com</textarea>
                        </div>
                        ...
                        <div className="input-group mb-3 info">
                            ...
                            <textarea id="firstName" className="update-task form-control update">firstName</textarea>
                            {/* last name */}
                            <div className="input-group-prepend">
                                <span className="input-group-text info">Last Name:</span>
                            </div>
                            <textarea id="lastName" className="update-task form-control update" >lastName</textarea>
                        </div>
                    ...
                    <div className="form-group">
                        ...
                        <input type="file" className="form-control-file" id="uploadFile" name="profilepic" aria-describedby="fileHelp"/>
                        <small id="fileHelp" className="form-text text-muted">File should be less than 3 mb</small>
                    </div>
                    ...
                    <div className="input-group mb-3 info">
                        ...
                        <textarea id="" className="update-task form-control update">
                        ...
                        <div className="input-group-append">
                            <button id="uploadUrl" upload-url>Upload</button>
                        </div>
                    </div>
